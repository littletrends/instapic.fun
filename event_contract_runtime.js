(function () {
  ...
  async function load(){
    ...
    <section class="contract-box"><h2>Key hire conditions</h2><p>The booking deposit is applied toward the hire total. The booking is secured only when this agreement is accepted and the deposit is successfully paid.</p>${x.attendance==="unattended"?`<p><strong>Unattended hire requires a separate $500 refundable security-bond authorisation.</strong> It is not included in the quote total. The security bond and remaining hire balance must be approved before the Magic Mirror is activated at the event.</p>`:""}<p>The hirer must provide safe setup and collection access, protect the equipment from weather, liquids, movement and interference, and is responsible for loss or damage beyond fair wear and faults not caused by the hirer.</p><p>Remote and AI-assisted operational monitoring may report equipment health but cannot guarantee every fault or incident is detected.</p><p><a href="terms.html" target="_blank" rel="noopener">Read the complete Instapic Event Hire Terms (version ${c.terms_version})</a></p></section>
