...
function main(PF) {
  ...
  function buildWorld(canvas) {
    ...
    const camera = new THREE.PerspectiveCamera(58, 1, 0.08, 80);
    ...
    camera.position.set(0.15, 2.4, 4.55);
