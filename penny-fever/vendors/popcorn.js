...
function initVendor(PF) {
  ...
  function bootWorld() {
    ...
    const camera = new THREE.PerspectiveCamera(46, 1.2, 0.08, 40);
    camera.position.set(1.35, 1.78, 3.15);
    world.camera = camera;
    world.camIdle = { x: 1.35, y: 1.78, z: 3.15 };
    world.camPlay = { x: 0, y: 2.98, z: 2.18 };
