...
export const TREASURE_ART = Object.freeze({
  'everyday-penny': './assets/everyday-penny.png',
  'moon-penny': './assets/moon-penny.png',
  'return-postcard': './assets/return-postcard.png',
  'message-bottle': './assets/message-bottle.png',
});
export const TREASURE_NAMES = Object.freeze({
...
export const COURSES = Object.freeze([
  {
    name: 'Pennies on the tide', subtitle: 'Skipper the Little Sailboat. Scoop three pennies.',
    hint: 'Nudge the Little Sailboat into each floating penny, then settle in the golden berth.',
    start: [445, 966], dock: [460, 285], par: 65,
    letters: [[300, 790], [627, 589], [361, 360]],
    finds: ['everyday-penny', 'everyday-penny', 'everyday-penny'],
    islands: [[450, 735, 63], [450, 490, 50]], gate: false, ferry: false, eddy: false,
  },
  {
    name: 'Mail on the water', subtitle: 'A moon penny and a postcard have drifted off the alley.',
    ...
    finds: ['moon-penny', 'return-postcard', 'everyday-penny'],
    islands: [[462, 769, 57], [317, 410, 35]], gate: true, ferry: false, eddy: false,
  },
  {
    name: 'A bottle for later', subtitle: 'A future curio is bobbing by the ferry.',
    ...
    finds: ['message-bottle', 'moon-penny', 'return-postcard'],
...
function tick(g, input, dt) {
  ...
  c.letters.forEach(([x, y], i) => {
    if (!g.letters[i] && Math.hypot(b.x - x, b.y - y) < 40) {
      g.letters[i] = true;
      g.events.push({ type: 'treasure', x, y, index: i, id: c.finds[i] });
    }
  });
