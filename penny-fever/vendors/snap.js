...
import { paperSlice, paperMaterial, paperProp, finishPaperStudio, tickPaperStudio } from "../world/paper-studio.js";
...
(() => {
  ...
  function makeMat(color, extra) {
    return paperMaterial(new THREE.MeshStandardMaterial(Object.assign({
  ...
  function makePop(kind) {
    ...
    if (paperSlice) { core.scale.z = 0.16; paperProp(core); }
    g.userData = {
  ...
  function bootWorld() {
    ...
    camera.position.set(0.2, 2.15, 8.6);
    ...
    loader.load(paperSlice ? "assets/restyle/paper-studio.png" : "assets/prepared/snap-freeze-flash.webp", (tex) => {
  ...
  function tickWorld(dt) {
    ...
    tickPaperStudio(world, t, frozen);
