import {games,byId} from './catalogue.js?v=tap-jump-2';
import {Draw,seeded,clamp} from './draw.js?v=glow-safe-1';
import {loadSprites,frontUrl} from './sprites.js';
import {kits,spriteKey,itemName} from './prizes.js?v=tap-jump-2';
...
try{
 ...
 engine=(await import(entry.module+'?v=tap-jump-2')).default;
