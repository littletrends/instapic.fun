import {games,byId} from './catalogue.js?v=dress-3e';
import {Draw,seeded,clamp} from './draw.js?v=glow-safe-1';
import {loadSprites,frontUrl} from './sprites.js';
import {kits,spriteKey,itemName} from './prizes.js?v=dress-3e';
...
try{
 ...
 engine=(await import(entry.module+'?v=dress-3e')).default;
