import {games,byId} from './catalogue.js?v=maze-ch1-4';
import {Draw,seeded,clamp} from './draw.js?v=glow-safe-1';
import {loadSprites,frontUrl} from './sprites.js';
import {kits,spriteKey,itemName} from './prizes.js?v=maze-ch1-4';
...
try{
 ...
 engine=(await import(entry.module+'?v=maze-ch1-4')).default;
