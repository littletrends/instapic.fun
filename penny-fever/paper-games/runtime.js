...
import {kits,spriteKey,itemName} from './prizes.js?v=prize-fly-1';
import {bindPrize,takePrize,stepPrize,paintPrize,PRIZE_FLY_TO} from './chapter-kit.js?v=prize-fly-1';
...
try{
 ...
 engine=(await import(entry.module+'?v=prize-fly-1')).default;
