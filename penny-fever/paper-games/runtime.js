import {games,byId} from './catalogue.js?v=maze-all-1';
import {Draw,seeded,clamp} from './draw.js?v=glow-safe-1';
import {loadSprites,frontUrl} from './sprites.js';
import {kits,spriteKey,itemName} from './prizes.js?v=maze-all-1';
...
try{
 ...
 engine=(await import(entry.module+'?v=maze-all-1')).default;
