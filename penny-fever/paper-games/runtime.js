...
try{
 ...
 engine=(await import(entry.module+(entry.id==='pinball'?'?v=pip-pass-1':entry.id==='milk-bottles'?'?v=milk-delivery-1':'?v=first-prize-1'))).default;
