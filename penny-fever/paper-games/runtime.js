...
import {byId} from './catalogue.js?v=peggy-mill-1';
...
try{
 ...
 engine=(await import(entry.module+'?v='+(entry.id==='curios'?'digby-claw-4':entry.id==='plinko'?'peggy-mill-1':'florence-fix-1'))).default;
