...
Deployment: validated in an isolated checkout after concurrent shared-file edits reverted part of the initial working change. Pending publication and live smoke check.
