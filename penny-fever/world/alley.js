...
import { paperRail, makePaperEntrance, installCrewGuest, updateCrewGuest, FOYER_IN, FOYER_OUT } from "./paper-guest-entrance.js?v=phone-images-2";
import { phoneLane } from "./phone-lane.js?v=keep-light-1";
import { installPaperCrew, updatePaperCrew } from "./paper-crew.js?v=phone-images-2";
import { installIndividualVendors } from "./paper-vendors.js?v=phone-images-2";
import {COUNTER, LOOP_START, makeVisibleTicketBooth, updateTicketBooth, extendPaperAlley, makePaperWalls, installTicketService, updateTicketService, paintAuraWallet} from "./paper-midway.js?v=phone-images-2";
...
import {installWallBackdrops} from "./walls/install.js?v=phone-images-2";
...
import {games as paperGames} from "../paper-games/catalogue.js?v=ride-seek-2";
import {enterLabel, isClosed} from "../paper-games/stall-entry.js?v=entry-3";

const CUTOUT = (id) => `assets/restyle/scene-turnarounds-2026-09-09/stalls/${id}/front.png`;
const STALLS = [
  { id: "fortune", kind: "tent", art: CUTOUT("fortune"), accent: 0x6b3a8a, line: "Gaze into the crystal. A keepsake is hiding in the mist." },
