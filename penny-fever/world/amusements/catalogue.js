...
export function papercutRideSrc(id,view){return `${PAPERCUT_ROOT}/amusements/${id}/${view}.png`;}
export function papercutHostSrc(host,view){return `${PAPERCUT_ROOT}/attendants/${host.toLowerCase()}/${view}.png`;}
