import {games} from '../paper-games/catalogue.js?v=dress-ready-2';
...
export const paperGameRooms=games.filter(game=>game.ready&&!game.workshop).map(game=>({
 ...game,src:new URL(game.direct||('play.html?stall='+encodeURIComponent(game.id)+'&room=alley&v=sep17-4'),gameBase).href,
}));
