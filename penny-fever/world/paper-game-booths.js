import {games} from '../paper-games/catalogue.js?v=live-cabinets-1';
...
export const paperGameRooms=games.filter(game=>game.ready&&!game.workshop).map(game=>({
 ...game,src:new URL(game.direct||('play.html?stall='+encodeURIComponent(game.id)+'&room=alley&v=milk-delivery-1'),gameBase).href,
}));
