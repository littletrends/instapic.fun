import {games} from '../../paper-games/catalogue.js?v=ritual-2';
import {kits} from '../../paper-games/prizes.js?v=ritual-3';
...
export const extras = [
  {
    ...
    workshop: false,
    extra: true,
    prizes: ['everyday-penny', 'five-penny-stack', 'ticket-roll', 'admission-ticket', 'night-suitcase'],
  ...
  },
  {
    ...
    host: 'Copper',
    title: 'The purse',
    blurb: 'Win the purse off Copper’s trays. Pack loose pennies into 5-packs here or at the machine so a full dump cannot swallow them.',
    workshop: false,
    extra: true,
