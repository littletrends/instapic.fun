...
(() => {
  'use strict';
  const rows = [
    ['everyday-penny','Everyday penny','Essentials','currency',null,'Aura’s ticket booth','Spend these at Copper Falls and Pip’s pin tables. Cash a booth ticket at either for a five-penny stack.',.07],
