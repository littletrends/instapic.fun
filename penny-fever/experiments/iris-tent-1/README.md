# Iris — Catch the Fortune

Tent 1 replacement imported from Acer `Desktop/TEST games on ACER LAPTOP/paper-games` on 14 September 2026. Artwork, six chapters, ring mechanics and canvas controls come from that build.

The live alley uses the existing wallet bridge: first gaze is practice with no rewards; subsequent gazes spend one penny. Ordinary rewards and chapter treasures go to the live purse/collection. The existing alley entry ticket remains in place. Standalone play uses a separate practice purse.
