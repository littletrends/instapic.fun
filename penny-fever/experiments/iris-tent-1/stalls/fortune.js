...
export default {
  ...
  images: {
    ...
    iris: "./assets/ui/iris.png",
    slip: "./assets/ui/fortune-slip.png",
    penny: "./assets/ui/practice-penny.png",
    key: "./assets/symbols/key.png",
    moon: "./assets/symbols/moon.png",
    eye: "./assets/symbols/eye.png",
    crown: "./assets/symbols/crown.png",
    moth: "./assets/symbols/moth.png",
    hand: "./assets/symbols/hand.png",
    star: "./assets/symbols/star.png",
    bottle: "./assets/symbols/bottle.png",
    crescent: "./assets/symbols/crescent.png",
    spark: "./assets/symbols/spark.png",
    lid: "./assets/symbols/lid.png",
    "fortune-slip": "./assets/prizes/fortune-slip.png",
    "moon-lantern": "./assets/prizes/moon-lantern.png",
    "moon-brooch": "./assets/prizes/moon-brooch.png",
    "fortune-journal": "./assets/prizes/fortune-journal.png",
    "moon-festival-fan": "./assets/prizes/moon-festival-fan.png",
    "looking-glass-locket": "./assets/prizes/looking-glass-locket.png",
  },
  actions: [],
  persist,
  hud(s) {
